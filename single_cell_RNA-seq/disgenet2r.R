...
# Searching by gene
data1 <- gene2disease( gene = 6334, vocabulary = "ENTREZ",
                       database = "ALL")
class(data1)
data1
...
data1 <- gene2evidence( gene = "SCN8A",
                        vocabulary = "HGNC",
                        disease ="C0014544",
                        database = "ALL",
                        score =c(0.3,1))
...
data3 <- disease2gene( disease  = "C0014544",
...
data4 <- disease2gene( disease  = "181500", vocabulary = "OMIM",
                       database = "CURATED",
                       score    = c(0.4,1 ) )
data4 <- disease2gene( disease  = "345.9", vocabulary = "ICD9CM",
                       database = "CURATED",
                       score    = c(0.4,1 ) )
data4 <- disease2gene( disease  = "C3020", vocabulary = "NCI",
                       database = "CURATED",
                       score    = c(0.4,1 ) )
data4
plot (data3,

...
ui <- fluidPage(theme = shinytheme( 
  ...
  sidebarLayout( 
    sidebarPanel(
      ...
      img(src = "https://github.com/wane199/Epilepsy_BLS_JNU/blob/main/EP_Cox_Nomo/shinyPredict/999logo.png?raw=true",
            # "https://github.com/wane199/Presentation/blob/master/EP/EP_Cox_Nomo/shinyPredict/999logo.png?raw=true",
          height = 100, width = 180),
